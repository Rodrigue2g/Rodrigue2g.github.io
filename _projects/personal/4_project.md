---
layout: page
title: Countryside House Electrical Renovation # Rural Electrical Infrastructure & Integration
description: FExtending power to a garden terrace through trenching, masonry work, and panel integration.
img: assets/img/personal_projects/home-electric-logo2.jpg
importance: 2
category: Personal
---
...
<div class="row">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/personal_projects/trench1.HEIC" title="Initial excavation" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/personal_projects/trench2.HEIC" title="Path to the pool" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/personal_projects/trench3.HEIC" title="Concrete channeling" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/personal_projects/first_wiring.HEIC" title="Prototyping the circuit" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/personal_projects/final_wiring2.HEIC" title="Final internal wiring" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/personal_projects/distrib_panel_wiring.HEIC" title="Legacy Distribution Panel" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/personal_projects/final_switch.HEIC" title="Finished Switch Installation" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/personal_projects/final_wiring1.HEIC" title="Final internal wiring" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption text-center">
